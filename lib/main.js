...
(function () {
  ...
  todoFx.loadList =
    [{ assign: false,
     ...
     { path:'lib/app.js'},
     { path:'assets/todo.fxml', fxml:'assets/todo.fxml', css:'assets/todo.css', cb:'loadAssets' },
     { path:'assets/todo.css', fxml:'assets/todo.fxml', css:'assets/todo.css', cb:'loadAssets' }
 ];
